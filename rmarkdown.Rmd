...
Recall that our last meeting entailed an introduction to rMarkdown's capabilties and getting each of your personal computers to generate a default template .html file. At this point in time, you are expected to:
...
Tonight we'll revisit the default template creation, but also:
...
---
## Let's try a .pdf file!!!!

There are two options to help knit a .pdf: MikTex and TinyTex 

> We're gonna do an experiment and have half of you install TinyTex and half MikTex!

MikTex:
1. Change your "html" YAML request to a "pdf"
2. Take note of the error and follow link and installation instructions

TinyTex
1. Install package `tinytex`
...
We're likely going to have individual problems here, so let's screenshare individually and try to help each other on everyone's local machines...

![](https://media.giphy.com/media/7z60uukpYWFLG/giphy.gif)
